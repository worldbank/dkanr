# Getting help with dkanr

Thanks for using dkanr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/dkanr/issues) to make sure the 
