...
This short introduction vignette shows you how to:

* Locate a dataset (the "Crowdsourced Price Data Collection Pilot"" dataset)
* Access its metadata
* Access download the .csv file of the data

__Accessing data via a DKAN user interface__

![Accessing data via a DKAN website](../inst/img/dkan_demo.gif)
...
### Use the resource node ID to retrieve the resource metadata  
...
## Querying data
Some data files may be directly queried through the API. Only data file that have been imported into the DKAN datastore can be queried through the API. 
