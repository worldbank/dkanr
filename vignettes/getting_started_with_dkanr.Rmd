...
Say we are interested in the following dataset: "Active Permits". The metadata for this node can be retrieved as follows: 
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, eval=FALSE}
